...
<body>
<div class="post">
<div class="title"><bean:message key="page.remove.flat.title" /></div>
<div class="entry"><html:form action="/removeFlat.do"
	method="post">
	<table>
		<tr>
			<td colspan="2" align="center"><bean:message
				key="flat.remove.preamble" /></td>
		</tr>
		<tr>
			<td colspan="2" align="center"><b><bean:write
				name="removeFlatForm" property="name" /></b></td>
		</tr>
		<tr>
			<td colspan="2" align="center"><bean:message
