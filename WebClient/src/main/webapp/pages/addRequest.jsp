...
<div class="entry"><html:form action="/addRequest.do"
	method="post">
	<table>
		<tr>
			<td colspan="2"><html:select name="addRequestForm"
				property="processName" onchange="onProcessSelect()">
				<html:options property="processes" />
			</html:select></td>
		</tr>
		<tr>
