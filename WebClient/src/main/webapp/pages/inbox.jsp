...
<div class="entry">
<p class="meta"><a style="background: black; color: white"
	href=" <html:rewrite page="/inbox.do"/>  " /> <bean:message
	key="inbox" />&nbsp;<a href="<html:rewrite page="/sentbox.do"/>">
<bean:message key="sent" /> </a></p>
<display:table name="sessionScope.inboxForm.messages" pagesize="20"
	...
	<display:column property="from" titleKey="message.from" sortable="true"
