...
<body>
<div class="post">
<div class="title"><bean:message key="user.remove.title" /></div>
<div class="entry"><html:form action="/removeUser.do"
	method="post">
	<table>
		<tr>
			<td colspan="2" align="center"><bean:message
				key="user.remove.preamble" /></td>
		</tr>
		<tr>
			<td colspan="2" align="center"><b><bean:write
				name="removeUserForm" property="login" /></b></td>
		</tr>
		<tr>
			<td colspan="2" align="center"><bean:message
